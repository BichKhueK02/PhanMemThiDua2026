        ...
        private void btn_Luu_Click(object? sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (var rd = cmd.ExecuteReader())
                {
                    if (rd.Read())
                    {
                        oldTk = Module_BaoMatAES.GiaiMa(rd.IsDBNull(0) ? "" : rd.GetString(0));
                        oldMk = Module_BaoMatAES.GiaiMa(rd.IsDBNull(1) ? "" : rd.GetString(1));
                ...
                cmdAdmin.Parameters.AddWithValue("@tk", Module_BaoMatAES.MaHoa(taiKhoanMoi));
                cmdAdmin.Parameters.AddWithValue("@mk", Module_BaoMatAES.MaHoa(matKhauMoi));
                cmdAdmin.Parameters.AddWithValue("@token", Module_BaoMatAES.MaHoa(token));
                ...
                {
                    cmdCH1.Parameters.AddWithValue("@ch", Module_BaoMatAES.MaHoa(cauHoi1));
                    cmdCH1.Parameters.AddWithValue("@tl", Module_BaoMatAES.MaHoa(traLoi1));
                ...
                {
                    cmdCH2.Parameters.AddWithValue("@ch", Module_BaoMatAES.MaHoa(cauHoi2));
                    cmdCH2.Parameters.AddWithValue("@tl", Module_BaoMatAES.MaHoa(traLoi2));
                ...
                if (!string.IsNullOrWhiteSpace(duongDan1))
                {
                    try
                    {
                        ...
                        if (rd.Read())
                        {
                            ...
                            tokenNguoiDung = Module_BaoMatAES.GiaiMa(rawToken);
                            if (string.IsNullOrWhiteSpace(tokenNguoiDung)) tokenNguoiDung = rawToken;
                            taiKhoanNguoiDung = Module_BaoMatAES.GiaiMa(rawTaiKhoan);
            ...
            foreach (var duongDan in csdls)
            {
                ...
                try
                {
                    ...
                    if (count == 0)
                    {
                        ...
                        cmdInsert.Parameters.AddWithValue("@token", Module_BaoMatAES.MaHoa(tokenNguoiDung));
                        cmdInsert.Parameters.AddWithValue("@tk", Module_BaoMatAES.MaHoa(taiKhoanNguoiDung));
                    ...
                    else
                    {
                        ...
                        cmdUpdate.Parameters.AddWithValue("@token", Module_BaoMatAES.MaHoa(tokenNguoiDung));
                        cmdUpdate.Parameters.AddWithValue("@tk", Module_BaoMatAES.MaHoa(taiKhoanNguoiDung));
