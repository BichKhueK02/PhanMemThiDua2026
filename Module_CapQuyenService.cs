...
namespace PhanMemThiDua2026
{
    internal static class Module_CapQuyenService
    {
        ...
        static Module_CapQuyenService()
        {
            try
            {
                string aesReversed = Module_BaoMatAES.XuyenKhongVeThoiMinhThanhToThanhTo(Cache_RAM_SYS_CFG_MOD_A) + Module_BaoMatAES.XuyenKhongVeThoiMinhThanhToThanhTo(Cache_RAM_SYS_CFG_MOD_B) + Module_BaoMatAES.XuyenKhongVeThoiMinhThanhToThanhTo(Cache_RAM_SYS_CFG_MOD_C);
                string hmacReversed = Module_BaoMatAES.XuyenKhongVeThoiMinhThanhToThanhTo(Cache_GPU_SEC_KEY_BLOCK_X) + Module_BaoMatAES.XuyenKhongVeThoiMinhThanhToThanhTo(Cache_GPU_SEC_KEY_BLOCK_Y) + Module_BaoMatAES.XuyenKhongVeThoiMinhThanhToThanhTo(Cache_GPU_SEC_KEY_BLOCK_Z);
                string aesKeyOriginal = Module_BaoMatAES.XinTraLaiThoiGian(aesReversed);
                string hmacKeyOriginal = Module_BaoMatAES.XinTraLaiThoiGian(hmacReversed);
